...
data_df = pd.read_csv('warblrb10k_public_metadata.csv')
#Import audio files.
audio_files=glob('warblrb10k_public_wav/wav/*.wav')
...
for i in range(len(audio_files)):
    ...
    plt.savefig('Chroma_STFTval.jpg',bbox_inches='tight',pad_inches = 0)

    # Will contain the feature
    features1 = []
    img1 = cv2.imread('Chroma_STFTval.jpg')
    img1 = transform(img1)
...
Data_Chroma_STFT.to_pickle("Data_Chroma_STFTval.pkl")